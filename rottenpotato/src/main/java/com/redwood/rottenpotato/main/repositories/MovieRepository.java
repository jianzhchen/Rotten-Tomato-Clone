...
public interface MovieRepository extends JpaRepository<Movie, Long> {
    ...
    @Query("SELECT m FROM Movie m WHERE m.director LIKE %:searchTerm% and m.movieKey<>:key")
    public List<Movie> searchByDirector(@Param("searchTerm") String searchTerm, @Param("key") String key, Pageable pageable);
}
